...
def predict():
    try:
        ...
        features = [
            data['Gender'],
            data['Job Satisfaction']=3, 
            data['Dietary Habits']="Moderate", 
            data['Profession']="Teacher", 
            data['Financial Stress']=3, 
            data['City']="Delhi", 
            data['Work/Study Hours']="10", 
            data['Study Satisfaction']="3", 
            data['Family History of Mental Illness']="No", 
            data['Degree']="MA",
            data['Age'], 
